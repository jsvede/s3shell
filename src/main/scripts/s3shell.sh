...
COMMAND="java $JAVA_OPTIONS $REMOTE_DEBUGGER -Dspring.profiles.active=s3shell.h2 -Dfile.encoding=UTF-8 -cp $PWD:$PWD/s3shell-0.6.0-all.jar jds.s3shell.S3Shell"
