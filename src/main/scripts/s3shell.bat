...
set COMMAND=java %JAVA_OPTIONS% %REMOTE_DEBUGGER% -Dspring.profiles.active=s3shell.h2 -Dfile.encoding=UTF-8 -cp %CURRENTDIR%;%CURRENTDIR%/s3shell-0.5.2-all.jar jds.s3shell.S3Shell
